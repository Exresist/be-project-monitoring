...
//nolint:wsl
type config struct {
	Env             string `required:"true" default:"development" desc:"production, development, stage, test"`
	DSN             string `required:"true" desc:"DSN для соединения с базой данных"`
	BindAddr        string `required:"true" default:"0.0.0.0:8080" split_words:"true" desc:"Адрес и порт входящих соединений"`
